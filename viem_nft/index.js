...
async function fetchNftOwner() {
  try {
    ...
    console.log('nft ownerOf:', NftOwner);
  } catch (error) {
    console.error('Error fetching nft ownerOf:', error);
  }
} 
...
async function fetchtokenURL() {
  try {
    ...
    console.error('Error fetching nft tokenURI:', error);
  }
} 
fetchBlockNumber();
fetchNftOwner();
